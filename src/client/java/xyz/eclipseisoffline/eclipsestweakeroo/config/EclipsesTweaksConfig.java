...
public class EclipsesTweaksConfig {
    ...
    public static final ConfigBooleanHotkeyed TWEAK_CREATIVE_ELYTRA_FLIGHT = createWithServerSideOptIn("tweakCreativeElytraFlight",
...
Configure using the "musicToast" options in Generic""", "Music toast tweak");
    public static final ConfigBooleanHotkeyed TWEAK_INVERT_MOUSE_X = create("tweakInvertMouseX", "Inverts mouse movement on the X-axis.\nBackport of the similar option introduced in 25w31a", "Invert mouse X");
    ...
    private static ConfigBooleanHotkeyed createWithServerSideOptIn(String name, String comment, String prettyName) {
        ServerSideOptInConfigOption config = new ServerSideOptInConfigOption(name, false, "", comment, prettyName);
        CONFIGS.add(config);
        return config;
    }
