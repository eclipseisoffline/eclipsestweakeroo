...
public class EclipsesDisableConfig {
    ...
    public static final ConfigBooleanHotkeyed DISABLE_ENTITY_COLLISIONS = createWithServerSideOptIn("disableEntityCollisions", "Disables entity collisions");
    public static final ConfigBooleanHotkeyed DISABLE_KNOCKBACK = createWithServerSideOptIn("disableKnockback", "Disables taking knockback");
    ...
    public static final ConfigBooleanHotkeyed DISABLE_HORSE_JUMP_CHARGE = createWithServerSideOptIn("disableHorseJumpCharge", "Disables (always maximises) the jump charge and cooldown on horses and similar entities");
    ...
    public static final ConfigBooleanHotkeyed DISABLE_USE_ITEM_SLOWDOWN = createWithServerSideOptIn("disableUseItemSlowdown", "Disables slowing down when using items, like eating food");
    ...
    public static final ConfigBooleanHotkeyed DISABLE_BABY_FEEDING = create("disableBabyFeeding", "Disables feeding of baby animals,\nmaking breeding animals easier when\nthere are a lot of animals in a small space");
    ...
    private static ConfigBooleanHotkeyed createWithServerSideOptIn(String name, String comment) {
        ServerSideOptInConfigOption config = new ServerSideOptInConfigOption(name, false, "", comment);
        CONFIGS.add(config);
        return config;
    }
