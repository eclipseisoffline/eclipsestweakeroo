...
public class AdditionalDisableConfig {
    ...
    public static final ConfigBooleanHotkeyed DISABLE_EQUIPMENT_RESTRICTION = new ConfigBooleanHotkeyed("disableArmorRestriction",
            false, "", "Disables the restriction armor slots have. May not work on servers",
            "Disable armor slot restriction");
    public static final ConfigBooleanHotkeyed DISABLE_BINDING_CURSE = new ConfigBooleanHotkeyed("disableBindingCurse",
