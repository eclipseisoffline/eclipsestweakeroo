...
public class AdditionalDisableConfig {
    ...
    public static final ConfigBooleanHotkeyed DISABLE_KNOCKBACK = new ConfigBooleanClient(
    ...
    public static final ConfigBooleanHotkeyed DISABLE_ITEM_COOLDOWN = new ConfigBooleanClient("disableItemCooldown", false, "", "Disables all item cooldowns (for items such as ender pearls, chorus fruits, etc.)");
    public static final ConfigBooleanHotkeyed DISABLE_ILLEGAL_CHARACTER_CHECK = new ConfigBooleanClient("disableIllegalCharacterCheck", false, "", "Disables the check for section characters in all text boxes");
    public static final ConfigBooleanHotkeyed DISABLE_BOW_DRAW_TIME = new ConfigBooleanClient("disableBowDrawTime", false, "", "Disables the draw time for (cross)bows");
}
